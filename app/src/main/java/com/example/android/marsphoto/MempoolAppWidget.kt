package com.example.android.marsphoto
...
internal suspend fun updateAppWidget(
    ...
    views.setTextViewText(R.id.textEconomyFee, fees.economyFee)

    // Set Hashrate and difficulty EH/s
    val currentHashrate = hashRate.currentHashrate.toDouble() / (1000000000000000000) //EH/s
